...
## 💰 Understanding the shMON Economy
...
```
Total Cost: ~0.15 MON
├── Buy-in: 0.1 shMON (locked in game)
├── Bonded Balance: 0.05 shMON (minimum for operations)
└── Gas Buffer: Variable (for transactions)
```

### Yield Distribution System
When a player is defeated, their balance is distributed:
- **75%** → Victor (player or monster that killed them)
- **25%** → **Yield Boost Pool** (distributed to ALL shMON holders)
