...
- Sessions last 1 day
- AutoTopup feature for automatic session key gas management
- Automatic management in background

### Task Automation

The Task Manager helps with strategic planning:
- **Movement**: All movement is synchronous and requires active input
